...
return {
    ["GetNames"] = function(p1) -- name: GetNames
        local v2 = {}
        for v3 = 1, #p1 do
            local Name = p1[v3].Name
            if not Name then
                local v5 = p1[v3]
                Name = tostring(v5)
            end
    ...
    ["MakeFuzzyFinder"] = function(p6) -- name: MakeFuzzyFinder
        local v_u_7 = nil
        local v_u_8 = {}
        ...
        if typeof(v16) ~= "Instance" then
            ...
            if typeof(v17) ~= "EnumItem" then
                ...
                local Name_0 = p6[1].Name
                if typeof(Name_0) ~= "string" then
                    goto l15
                end
            end
        end
