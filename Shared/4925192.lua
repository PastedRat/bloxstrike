...
local v_u_3 = {}
local v_u_4 = 0
function v_u_1.IsDoublePressed() -- name: IsDoublePressed
    -- upvalues: (ref) v_u_4
    return tick() - v_u_4 < 0.1
end
function v_u_1.Add(p_u_5, p_u_6, p_u_7) -- name: Add
    -- upvalues: (copy) v_u_3
    local v8 = v_u_3
    table.insert(v8, {
        ["closeButton"] = p_u_6,
...
function v_u_1.CloseFrame() -- name: CloseFrame
...
UserInputService.InputBegan:Connect(function(p12)
    -- upvalues: (copy) v_u_1
