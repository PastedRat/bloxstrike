...
local v_u_7 = {}
local function v_u_22(p8, p9, p10, p11) -- name: constructAsset
    -- upvalues: (copy) Other, (copy) v_u_6, (copy) Debris
    local v12 = Other:FindFirstChild(p8)
...
return function(p_u_23, p24, p25, p26)
    -- upvalues: (copy) v_u_7, (copy) m_Janitor, (copy) v_u_22
